...
$pairings = [
    'BTC|TKTS',
    'BCH|TKTS',
    'ETH|TKTS', // This pairing does not support conversions and should throw an error.
    'LTC|TKTS'  // This pairing does not support conversions and should throw an error.
];
