<?php
require('../src/TicketsplayCurlRequest.php');
require('../src/keys.php');

use PHPUnit\Framework\TestCase;

class TicketsplayCurlRequestTest extends TestCase
{
    private $curl_test;
    ...
    {
        $this->curl_test = new TicketsplayCurlRequest($this->private_key, $this->public_key, $this->format);
    }

    /**
     * @covers TicketsplayCurlRequest::__construct
     */
    public function testInit()
    {
        $this->assertInstanceOf(TicketsplayCurlRequest::class, $this->curl_test);
    ...
    {
        $this->empty_curl_test = new TicketsplayCurlRequest();
    }
    ...
    {
        $this->empty_curl_test = new TicketsplayCurlRequest('key');
    }

    /**
     * @covers TicketsplayCurlRequest::execute
     * @expectedException ArgumentCountError
     */
