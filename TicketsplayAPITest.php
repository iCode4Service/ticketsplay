<?php
require('../src/Ticketsplay.php');
require('../src/keys.php');

use PHPUnit\Framework\TestCase;

class TicketsPlayAPI extends TestCase
{
    private $api;

    protected function setUp()
    {
        $this->api = new TicketsPlayAPI(API_PRIVATE_KEY, API_PUBLIC_KEY, 'json');
    }
    ...
    /**
     * @covers TicketsPlayAPI::__construct
     * @expectedException ArgumentCountError
     */
    public function testEmptySetupofApiInstance()
    {
        $this->api = new TicketsPlayAPI();
    }
    ...
    {
        $this->failed_api_one_key = new TicketsPlayAPI('key');
    }
    ...
    {
        $this->assertInstanceOf(TicketsPlayAPI::class, $this->api);
        $this->assertObjectHasAttribute('request_handler', $this->api);
        $this->assertAttributeInstanceOf(TicketsplayCurlRequest::class, 'request_handler', $this->api);
    }

    /**
     * @covers TicketsPlayAPI::getBasicInfo
     */
    ...
    /**
     * @covers TicketsPlayAPI::getRates
     *
    ...
    /**
     * @covers TicketsPlayAPI::GetRatesWithAccepted
     *
     * Note this test randomly checks any one of the returned rate values.
     */
    ...
    /**
     * @covers TicketsPlayAPI::GetShortRates
     *
     * Note this test randomly checks any one of the returned rate values.
     */
    ...
    /**
     * @covers TicketsPlayAPI::GetShortRatesWithAccepted
     *
     * Note this test randomly checks any one of the returned rate values.
     */
    ...
    /**
     * @covers TicketsPlayAPI::GetCoinBalances
     *
    ...
    /**
     * @covers TicketsPlayAPI::GetAllCoinBalances
     */
    ...
    /**
     * @covers TicketsPlayAPI::GetDepositAddress
     */
    public function testGetDepositAddress()
    {
        $response = $this->api->GetDepositAddress('TKTS');
        $this->checkResponseFormat($this, $response);
    ...
    /**
     * @covers TicketsPlayAPI::GetOnlyCallbackAddress
     */
    public function testGetOnlyCallbackAddress()
    {
        $response = $this->api->GetOnlyCallbackAddress('TKTS');
        $this->checkResponseFormat($this, $response);
        $this->assertArrayHasKey('address', $response['result']);
        $this->assertInternalType('string', $response['result']['address']);
    }
    ...
    /**
     * @covers TicketsPlayAPI::GetCallbackAddressWithIpn
     *
     ...
     * @link https://45.32.184.209/merchant-tools-ipn
     */
    public function testGetCallbackAddressWithIpn()
    {
        $response = $this->api->GetCallbackAddressWithIpn('TKTS', 'https://45.32.184.209/sample-ipn-address');
        $this->checkResponseFormat($this, $response);
        $this->assertArrayHasKey('address', $response['result']);
        $this->assertInternalType('string', $response['result']['address']);
    }
    ...
    {
        $response = $this->api->GetCallbackAddressWithIpn('NXT', 'https://45.32.184.209/sample-ipn-address');
        $this->checkResponseFormat($this, $response);
        $this->assertArrayHasKey('address', $response['result']);
        $this->assertInternalType('string', $response['result']['address']);
        $this->assertArrayHasKey('pubkey', $response['result']);
    ...
    {
        $response = $this->api->GetCallbackAddressWithIpn('XRP', 'https://45.32.184.209/sample-ipn-address');
        $this->checkResponseFormat($this, $response);
        $this->assertArrayHasKey('address', $response['result']);
        $this->assertInternalType('string', $response['result']['address']);
        $this->assertArrayHasKey('dest_tag', $response['result']);
    ...
    /**
     * @covers TicketsplayAPI::GetConversionLimits
     */
    ...
    /**
     * @covers TicketsplayAPI::GetTxInfoSingle
     */
    ...
    /**
     * @covers TicketsplayAPI::GetTxInfoSingleWithRaw
     */
    ...
    /**
     * @covers TicketsplayAPI::GetTxInfoMulti
     */
    ...
    /**
     * @covers TicketsplayAPI::GetSellerTransactionList
     */
    ...
    /**
     * @covers TicketsplayAPI::GetFullTransactionList
     */
    ...
    /**
     * @covers TicketsplayAPI::CreateSimpleTransaction
     */
    public function testCreateSimpleTransaction()
    {
        $response = $this->api->CreateSimpleTransaction('0.001', 'TKTS', API_TESTS_BUYER_EMAIL);
        $this->checkResponseFormat($this, $response);
        $this->assertArrayHasKey('amount', $response['result']);
    ...
    /**
     * @covers TicketsplayAPI::CreateSimpleTransactionWithConversion
     */
    public function testCreateSimpleTransactionWithConversion()
    {
        $response = $this->api->CreateSimpleTransactionWithConversion('0.01', 'BTC', 'TKTS', API_TESTS_BUYER_EMAIL);
        $this->checkResponseFormat($this, $response);
        $this->assertArrayHasKey('amount', $response['result']);
        $this->assertInternalType('string', $response['result']['amount']);
        $this->assertArrayHasKey('txn_id', $response['result']);
    ...
    /**
     * @covers TicketsplayAPI::CreateComplexTransaction
     *
     * Note the IPN URL passed is only a test example.
     * In production your IPN URL must reside on your own web server and be configured to receive notifications!
     * @link https://45.32.184.209/merchant-tools-ipn
    ...
    {
        $response = $this->api->CreateComplexTransaction('0.01', 'BTC', 'TKTS', API_TESTS_BUYER_EMAIL, API_TESTS_TKTS_TO, 'SampleBuyerName', 'SampleItemName', 'SampleItemNumber', 'SampleInvoice', 'SampleCustom', 'https://45.32.184.209/sample-ipn-address');
        $this->checkResponseFormat($this, $response);
        $this->assertArrayHasKey('amount', $response['result']);
        $this->assertInternalType('string', $response['result']['amount']);
        $this->assertArrayHasKey('txn_id', $response['result']);
    ...
    /**
     * @covers TicketsplayAPI::CreateCustomTransaction
     */
    ...
    /**
     * @covers TicketsplayAPI::CreateMerchantTransfer
     */
    public function testCreateMerchantTransfer()
    {
        $response = $this->api->CreateMerchantTransfer('0.01', 'TKTS', API_TESTS_ALT_MID);
        $this->checkResponseFormat($this, $response);
    ...
    /**
     * @covers TicketsplayAPI::CreatePayByNameTransfer
     */
    public function testCreatePayByNameTransfer()
    {
        $response = $this->api->CreatePayByNameTransfer('0.01', 'TKTS', API_TESTS_PBN);
        $this->checkResponseFormat($this, $response);
        $this->assertArrayHasKey('id', $response['result']);
        $this->assertInternalType('string', $response['result']['id']);
        $this->assertArrayHasKey('status', $response['result']);
    ...
    /**
     * @covers TicketsplayAPI::GetWithdrawalHistory
     *
    ...
    /**
     * @covers TicketsplayAPI::GetWithdrawalInformation
     */
    ...
    /**
     * @covers TicketsplayAPI::CreateWithdrawal
     */
    ...
    /**
     * @covers TicketsplayAPI::CreateMassWithdrawal
     */
    ...
    /**
     * @covers TicketsplayAPI::GetProfileInformation
     */
    ...
    /**
     * @covers TicketsplayAPI::GetTagList
     */
    ...
    /**
     * @covers TicketsplayAPI::UpdateTagProfile
     */
    ...
    /**
     * @covers TicketsplayAPI::ConvertCoins
     */
    ...
    /**
     * @covers TicketsplayAPI::GetConversionInformation
     */
    ...
    /**
     * @covers TicketsplayAPI::ClaimPayByNameTag
     */
