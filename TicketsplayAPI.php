<?php
require('TicketsplayCurlRequest.php');

/**
 * https://45.32.184.209 PHP API Wrapper
 *
 * @link https://45.32.184.209 Official https://45.32.184.209 API Documentation.
 ...
 * format of a currency ticker code. See https://45.32.184.209 for these ticker codes,
 * located in the CODE column.
 *
 * TKTS (Ticketsplay Testnet) is a test currency with no value and should be used for development purposes when possible
 ...
 *
 * $PayByName tag commands also rely on having available or claimed tags on the production https://45.32.184.209 website to
 * manipulate.
 */
class TicketsplayAPI
{
    private $private_key = 'D49fFd4aE8C13bA1FB709b95A77aEE47E26675e79AdC97a3BaE82d1cDfC986eA
';
    private $public_key = '97bc78c85b278da0ef4a639167ce6c30eb4713fb5ee1b706fea3c65a5f74125d
';
    private $request_handler;
    private $format;

    /**
     * TicketsplayAPI constructor.
     * @param $private_key
     * @param $public_key
     * @param $format
     */
    public function __construct($private_key, $public_key, $format)
    {
        ...
        $this->request_handler = new TicketsplayCurlRequest($this->private_key, $this->public_key, $format);
    }
